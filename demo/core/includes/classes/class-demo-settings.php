 ...
 *
 * @package		DEMO
 * @subpackage	Classes/Demo_Settings
...
class Demo_Settings{
	...
	public function get_plugin_name(){
		return apply_filters( 'DEMO/settings/get_plugin_name', $this->plugin_name );
	}
}
